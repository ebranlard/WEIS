...
fig,axes = plt.subplots(1,len(IFreq), sharex=True, figsize=(13.4,3.4)) # (6.4,4.8)
fig.subplots_adjust(left=0.06, right=0.91, top=0.93, bottom=0.12, hspace=0.20, wspace=0.50)
...
cbar_ax = fig.add_axes([0.930, 0.13, 0.02, 0.772])
cbar=fig.colorbar(ims[2], cax=cbar_ax)
fig.savefig(caseName+'_contourFreq.png')
...
cbar_ax = fig.add_axes([0.930, 0.13, 0.02, 0.772])
cbar=fig.colorbar(ims[2], cax=cbar_ax)
fig.savefig(caseName+'_contourDamp.png')
